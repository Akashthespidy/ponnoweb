...
const IconWrapper = ({
  ...
  <div
    className={`
      ...
      ${
        isHighlighted
          ? "bg-gradient-to-br from-blue-600 to-purple-600 border-blue-400/50 shadow-blue-400/30 shadow-2xl animate-breathing-glow"
          : `${color} border-gray-200/50 ${!isActive && "animate-float"}`
      }
      ${
          ...
          {retentionTools.map((tool) => (
            <div
              ...
              className={`px-4 py-2 rounded-full ${
                tool.color
              }/20 backdrop-blur-sm flex items-center gap-2 border border-white/20 transition-all ${
              ...
              >
                <div className="-translate-x-1/2 -translate-y-1/2">
                  <IconWrapper
                    ...
                    color={tool.color}
                  >
                    <div className="text-white">{tool.component}</div>
                  </IconWrapper>
                </div>
              </div>
            );
